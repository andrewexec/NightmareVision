 ...
 * This shader is used for more complex shading effects.
 * 
...
class AdvancedDropShadowShader extends flixel.system.FlxAssets.FlxShader
{
	/**
	 ...
	 */
	public var layers:Array<AdvancedDropShadowLayer>;
	/**
	 ...
	 * @return	This `AdvancedDropShadowShader` instance (useful for chaining)
	 */
	public function copyFrom(from:AdvancedDropShadowShader):AdvancedDropShadowShader
	{
	 ...
	 * @return	This `AdvancedDropShadowShader` instance (useful for chaining)
	 */
	public function setColorMatrix(matrix:Array<Float>, normalizedOffset:Bool = true):AdvancedDropShadowShader
	{
		colorMatrix = matrix;
		
		if (!normalizedOffset) {
			for (i in 0 ... shadowOffsets.value.length) shadowOffsets.value[i] /= 255;
		}
	 ...
	 * @return	This `AdvancedDropShadowShader` instance (useful for chaining)
	 */
	public function setAdjustColor(brightness:Float = 0, hue:Float = 0, contrast:Float = 0, saturation:Float = 0):AdvancedDropShadowShader
	{
		return setColorMatrix(animate.internal.filters.AdjustColorFilter.getColorMatrix(brightness, hue, contrast, saturation), false);
	}
	/**
	 ...
	 * @return	This `AdvancedDropShadowShader` instance (useful for chaining)
	 */
	public function setHollowColorMatrix(matrix:Array<Float>, normalizedOffset:Bool = true):AdvancedDropShadowShader
	{
		hollowColorMatrix = matrix;
		
		if (!normalizedOffset) {
			for (i in 0 ... hollowOffsets.value.length) hollowOffsets.value[i] /= 255;
		}
	 ...
	 * @return	This `AdvancedDropShadowShader` instance (useful for chaining)
	 */
	public function setHollowAdjustColor(brightness:Float = 0, hue:Float = 0, contrast:Float = 0, saturation:Float = 0):AdvancedDropShadowShader
	{
		return setHollowColorMatrix(animate.internal.filters.AdjustColorFilter.getColorMatrix(brightness, hue, contrast, saturation), false);
	}
	 ...
	 * @return	The new `AdvancedDropShadowLayer` that was added (useful for chaining)
	 */
	public function addLayer(colorMatrix:Array<Float>, angle:Float = 0, distance:Float = 20, threshold:Float = .01, strength:Float = 1, roughness:Float = 1):AdvancedDropShadowLayer
	{
		var rimlight:AdvancedDropShadowLayer = getFreeLayer();
	...
	function getFreeLayer():Null<AdvancedDropShadowLayer>
	{
	...
	/**
	 * Creates a new `AdvancedDropShadowShader`.
	 */
	public function new()
	{
		super();
	...
	inline function set_colorMatrix(matrix:Array<Float>):Array<Float>
	{
		...
		for (i in 0 ... 4) shadowOffsets.value[i] = matrix[i * 5 + 4];
	...
	inline function set_hollowColorMatrix(matrix:Array<Float>):Array<Float>
	{
		...
		for (i in 0 ... 4) hollowOffsets.value[i] = matrix[i * 5 + 4];
...
/**
 * Represents a lighting layer in the `AdvancedDropShadowShader`
 */
@:access(animate.internal.filters.AdjustColorFilter)
private class AdvancedDropShadowLayer
{
	/**
	 ...
	 * @return	This `AdvancedDropShadowLayer` instance (useful for chaining)
	 */
	public function copyFrom(from:AdvancedDropShadowLayer):AdvancedDropShadowLayer
	{
	 ...
	 * @return	This `AdvancedDropShadowLayer` instance (useful for chaining)
	 */
	public inline function setAttributes(angle:Float = 0, distance:Float = 20, threshold:Float = .01, strength:Float = 1, roughness:Float = 1):AdvancedDropShadowLayer
	{
		this.angle = angle;
	 ...
	 * @return	This `AdvancedDropShadowLayer` instance (useful for chaining)
	 */
	public function setColorMatrix(matrix:Array<Float>, normalizedOffset:Bool = true):AdvancedDropShadowLayer
	{
		colorMatrix = matrix;
		
		if (!normalizedOffset) {
			for (i in 0 ... offsets.length) offsets[i] /= 255;
		}
	 ...
	 * @return	This `AdvancedDropShadowLayer` instance (useful for chaining)
	 */
	public function setAdjustColor(brightness:Float = 0, hue:Float = 0, contrast:Float = 0, saturation:Float = 0):AdvancedDropShadowLayer
	{
		return setColorMatrix(animate.internal.filters.AdjustColorFilter.getColorMatrix(brightness, hue, contrast, saturation), false);
	}
	...
	inline function get_colorMatrix():Array<Float>
	{
		return [for (i in 0 ... 20) (i % 5 == 4 ? offsets[Math.floor(i / 5)] : multipliers[i - Math.floor(i / 5)])];
	}
	inline function set_colorMatrix(matrix:Array<Float>):Array<Float>
	{
		for (i in 0 ... 16) multipliers[i] = (matrix[i + Math.floor(i / 4)] ?? 0);
		for (i in 0 ... 4) offsets[i] = (matrix[i * 5 + 4] ?? 0);
